...
const Footer = () => {
  return (
    <footer className="wro-footer">
      {/* Top Bright Accent Line */}
      ...
      <div className="footer-wrapper">
        ...
        <div className="footer-logo-container">
          <Link to="/">
            <img src="/Logo.png" alt="RoboFest Logo" className="wro-logo" />
          </Link>
        </div>
        ...
        <div className="footer-grid">
          ...
          <div className="grid-col">
            ...
            <div className="address-block">
              <p>RoboFest Pakistan</p>
              <p>Plot C 116, F.B Area Block 6</p>
              <p>Gulberg Town, Karachi 75950</p>
              <p>Pakistan</p>
            </div>
        ...
        {/* Disclaimer / Mission Bottom Paragraph */}
        <div className="footer-notice">
          <p>
            <strong>RoboFest Pakistan</strong> is an independent non-profit initiative.
            All revenue from sponsorships and fees is invested in support of our mission, which is
            to promote robotics and STEM education nationwide.
          </p>
        </div>
      </div>
    </footer>
